			...
			<form action="/add-book" method="post" class="form-horizontal">
				<table class="table table-striped table-hover">
					<tr>
						...
						<td>
							<div
								class="<ex:CssClassHandler defaultClass="form-group" fieldName="title" errorList="${errors}" />">
					...
					<tr>
						...
						<td>
							<div
								class="<ex:CssClassHandler defaultClass="form-group" fieldName="author" errorList="${errors}" />">
