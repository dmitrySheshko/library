...
<div>
    ...
    <div id="registration">
        ...
        <form action="/auth/sign-up" method="post" class="form-horizontal">
            ...
            <div class="<ex:CssClassHandler defaultClass="form-group" fieldName="lastName" errorList="${errors}" />">
            ...
            <c:if test="${sessionUser != null && sessionUser.role == 'ADMIN'}">
                <div class="<ex:CssClassHandler defaultClass="form-group" fieldName="role" errorList="${errors}" />">
                    ...
                    <div class="col-lg-8">
                        <div class="radio">
                            <label>
                                <input type="radio" name="role" value="LIBRARIAN" <c:if test = "${user.role == 'LIBRARIAN'}">checked="checked"</c:if>>
                                Librarian
                            </label>
                        </div>
                        <div class="radio">
                            <label>
                                <input type="radio" name="role" value="READER" <c:if test = "${user.role == 'READER'}">checked="checked"</c:if>>
                                Reader
                            </label>
                        </div>
                    </div>
